...
/***** module 0 start *****/
/***** node_modules\wepy-web\lib\components\navigator.vue *****/
...
exports.default = {
    ...
    methods: {
        click: function click() {
            var hash = _util2.default.$resolvePath(this.$route.path, this.url);
...
/***** module 1 start *****/
/***** node_modules\wepy-web\lib\components\button.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
var BUTTON_TYPES = ['default', 'primary', 'warn'];
...
exports.default = {
    ...
    props: {
        ...
        'plain': {
            type: [Boolean, String],
            default: false,
            coerce: (0, _util.stringToBoolean)()
        },
        'disabled': {
            type: [Boolean, String],
            default: false,
    ...
    methods: {
        touchstart: function touchstart() {
            ...
            if (!this.startInterval && this.hoverClass !== 'none' && this.hoverClass !== '') {
                // 实测'none'和''都不会触发hover
        ...
        touchend: function touchend() {
            ...
            if (!this.stayInterval && this.hoverClass !== 'none' && this.hoverClass !== '') {
                this.stayInterval = setInterval(function () {
...
var VALID_TYPES = ['success', 'success_no_circle', 'circle', 'info_circle', 'info', 'warn', 'waiting', 'cancel', 'download', 'search', 'clear'];
...
/***** module 3 start *****/
/***** node_modules\wepy-web\lib\components\progress.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
exports.default = {
    ...
    props: {
        'percent': {
            type: [Number, String],
            default: 0,
            validator: function validator(percent) {
...
/***** module 4 start *****/
/***** node_modules\wepy-web\lib\components\slider.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
exports.default = {
    ...
    props: {
        'min': {
            type: [Number, String],
            default: 0,
            validator: (0, _util.numberValidator)()
        },
        'max': {
            type: [Number, String],
            default: 100,
    ...
    methods: {
        ...
        click: function click(e) {
            if (this.disabled) return;
            var dist = e.clientX - e.currentTarget.offsetLeft;
            dist = dist < 0 ? 0 : dist > this.totalLen ? this.totalLen : dist;
            this.value = parseInt(dist / this.totalLen * 100);
            this.$emit('change', {
                type: 'change',
...
/***** module 6 start *****/
/***** node_modules\wepy-web\lib\components\radio-group.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
/***** module 7 start *****/
/***** node_modules\wepy-web\lib\components\checkbox.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
exports.default = {
    ...
    methods: {
        getCheckboxValue: function getCheckboxValue() {
            var $checkboxLists = document.getElementsByName(this.checkboxName);
            var checkboxValue = [];

            [].slice.call($checkboxLists).forEach(function ($checkbox) {
...
/***** module 8 start *****/
/***** node_modules\wepy-web\lib\components\checkbox-group.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
/***** module 9 start *****/
/***** node_modules\wepy-web\lib\components\switch.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
/***** module 10 start *****/
/***** node_modules\wepy-web\lib\apis\showToast.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
function getter(constructor) {
    ...
    return function (config) {
        ...
        if (!_this.instance) {
            _this.instance = new constructor({
                el: document.createElement('div')
            });
            _this.instance.$appendTo(document.body);
        }
        wx.$toast = _this.instance;
        Object.assign(_this.instance, DEFAULT_PROPERTIES, { fail: void 0, success: void 0, complete: void 0 }, config);
        _this.instance.show = true;

        typeof config.success === 'function' && config.success();
        typeof config.complete === 'function' && config.complete();

        setTimeout(function () {
            _this.instance.show = false;
        }, _this.instance.duration);
    };
}
...
/***** module 11 start *****/
/***** node_modules\wepy-web\lib\apis\showActionSheet.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
/***** module 12 start *****/
/***** node_modules\wepy-web\lib\apis\showModal.vue *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
/***** module 13 start *****/
/***** src\pages\list.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <scroll-view  v-on:scrollBottom=\"nextPage\" class=\"list\">\n        <div class=\"filter\">\n            <div @click=\"toggleSort($event)\" :class=\"(filter.sort===SORT.popular?'active item':'item')\" :data-sort=\"(SORT.popular)\">人气 </div>\n            <div @click=\"toggleSort($event)\" :class=\"(filter.sort===SORT.sales?'active item':'item')\" :data-sort=\"(SORT.sales)\">销量</div>\n            <div @click=\"toggleSort($event)\" :class=\"(filter.sort===SORT.price?'active item':'item')\" :data-sort=\"(SORT.price)\">价格</div>\n\n            <wepy-checkbox-group @change=\"selectCoupon($event)\" class=\"checkbox\">\n                <label>\n                    <wepy-checkbox value=\"true\" :checked=\"(filter.has_coupon)\"></wepy-checkbox>优惠劵\n                </label>\n            </wepy-checkbox-group>\n        </div>\n\n        <div class=\"list\">\n            <div class=\"item\" @click=\"godetils($event)\" v-for=\"(index, item) in (list)\" :wx:key=\"(index)\" :data-num_iid=\"(item.num_iid)\" :data-coupon_id=\"(item.coupon_id)\" :data-coupon=\"(item.coupon || '促销')\">\n                <img mode=\"widthFix\" :src=\"(item.pict_url)\"/>\n                <div class=\"title\">{{item.title}}</div>\n\n                <div class=\"ltr\">\n                    <div class=\"coupon\">{{item.coupon || '促'}}</div>\n                    <div class=\"endprice\">￥{{item.zk_final_price}}</div>\n                </div>\n                <div class=\"ltr\">\n                    <div></div>\n                    <div class=\"xl\">已售{{item.volume}}</div>\n                </div>\n            </div>\n        </div>\n    </scroll-view>\n"},/***** module 13 end *****/


/***** module 14 start *****/
/***** src\pages\index.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"index page\">\n        <div class=\"z-search\">\n            <div class=\"input\" @click=\"toSearch($event)\">输入关键词搜索</div>\n        </div>\n        <my-swiper indicator-dots=\"true\" autoplay=\"true\" interval=\"3000\" duration=\"500\" :style=\"'height:' + (imageHeight) + 'px;'\">\n            <div v-for=\"(index, item) in (imgUrls)\">\n                <swiper-item>\n                    <img class=\"slide-image\" mode=\"widthFix\" @click=\"hd($event)\" :src=\"(item.img)\" :data-index=\"(index)\"/>\n                </swiper-item>\n            </div>\n        </my-swiper>\n        <div class=\"special\">\n            <div>\n                <div class=\"iconfont icon-ticket\">特惠推荐</div>\n            </div>\n            <div class=\"weui-flex thtj\">\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"9k9\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1_UFmOXXXXXc4aXXXXXXXXXXX-794-320.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"20k\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1fztJOXXXXXcfXpXXXXXXXXXX-794-320.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"tjhh\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1gKlIOXXXXXcJXpXXXXXXXXXX-794-320.png\"/>\n            </div>\n        </div>\n        <div class=\"special\">\n            <div>\n                <div class=\"iconfont icon-tao\">淘宝行业市场精选</div>\n            </div>\n            <div class=\"weui-flex hyjx hyjx1\">\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"ifashion\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1JQ9gKFXXXXX.XFXXXXXXXXXX-592-236.jpg\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"qbb\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1oyxZNpXXXXbdXVXXXXXXXXXX-594-236.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"tbhc\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1EdnZKpXXXXc9XpXXXXXXXXXX-592-236.png\"/>\n            </div>\n            <div class=\"weui-flex hyjx hyjx2\">\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"cdj\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB10R6.KpXXXXceXXXXXXXXXXXX-592-236.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"jyj\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1sGn9KpXXXXXPXpXXXXXXXXXX-592-236.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"kdc\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1W.6YKpXXXXbBXFXXXXXXXXXX-592-236.png\"/>\n\n            </div>\n            <div class=\"weui-flex hyjx hyjx2\">\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"tbdiy\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1xZCmKFXXXXalXpXXXXXXXXXX-592-236.jpg\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"gyhd\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1IMTTKpXXXXXIXVXXXXXXXXXX-592-236.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"gyhd\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1IMTTKpXXXXXIXVXXXXXXXXXX-592-236.png\"/>\n            </div>\n        </div>\n        <div class=\"special\">\n            <div>\n                <div class=\"iconfont icon-appreciate_light\">行业好货</div>\n            </div>\n            <div class=\"weui-flex hyjx hyhh\">\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"nzjh\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1MLBTOXXXXXa.XXXXXXXXXXXX-586-800.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"myrt\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB1k94bOXXXXXanaFXXXXXXXXXX-586-800.png\"/>\n                <img class=\"weui-flex__item\" @click=\"theme($event)\" data-type=\"gyhd\" mode=\"widthFix\" src=\"http://img.alicdn.com/tps/TB18MXoMpXXXXXRXVXXXXXXXXXX-586-800.png\"/>\n            </div>\n        </div>\n    </div>\n"},/***** module 14 end *****/


/***** module 15 start *****/
/***** src\pages\search.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"search page\">\n        <div class=\"search\">\n            <input placeholder=\"输入关键词搜索\" @input=\"inputValue($event)\"/>\n            <wepy-button @click=\"search($event)\">搜索</wepy-button>\n        </div>\n        <div class=\"hot\">\n            <div class=\"title\" @click=\"search($event)\">热门搜索</div>\n            <div class=\"tag\">\n                <div class=\"tag-item\" @click=\"selectTag($event)\" v-for=\"(index, item) in (tags)\" :data-item=\"(item)\">{{item}}</div>\n            </div>\n        </div>\n        <div class=\"hot history\">\n            <div class=\"title\">历史搜索\n                <div class=\"iconfont icon-delete\" @click=\"clearHistory($event)\"></div>\n            </div>\n            <div class=\"tag\">\n                <div class=\"tag-item\" @click=\"selectTag($event)\" v-for=\"(index, item) in (history)\" :data-item=\"(item)\">{{item}}</div>\n            </div>\n        </div>\n    </div>\n"},/***** module 15 end *****/


/***** module 16 start *****/
/***** node_modules\wepy-web\lib\components\navigator.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <a href=\"javascript:;\" class=\"wepy_navigator\"  v-bind:class.once=\"hover ? hoverClass : ''\" @touchstart=\"touchstart($event)\" @touchend=\"touchend($event)\" @click=\"click($event)\"><slot></slot></a>\n"},/***** module 16 end *****/
...
/***** module 18 start *****/
/***** node_modules\wepy-web\lib\components\button.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <button class=\"wepy_button\"  v-bind:size.once=\"size\" v-bind:disabled.once=\"disabled\" v-bind:plain.once=\"plain\" v-bind:class.once=\"isHover ? hoverClass : ''\" @touchstart=\"touchstart($event)\" @touchend=\"touchend($event)\" :type=\"(type)\"><slot></slot></button>\n"},/***** module 18 end *****/


/***** module 19 start *****/
/***** node_modules\wepy-web\lib\components\icon.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy_icon\"  v-bind:class.once=\"'wepy_icon-' + type\" v-bind:style.once=\"style\"></div>\n"},/***** module 19 end *****/


/***** module 20 start *****/
/***** node_modules\wepy-web\lib\components\progress.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy_progress\">\n        <div class=\"wepy_progress-bar\"  v-bind:style.once=\"barStyle\">\n            <div class=\"wepy_progress-inner_bar\" v-bind:style.once=\"innerBarStyle\"></div>\n        </div>\n        <div v-show=\"showInfo\" class=\"wepy_progress-percent\">{{ percent + '%' }}</div>\n    </div>\n"},/***** module 20 end *****/


/***** module 21 start *****/
/***** node_modules\wepy-web\lib\components\slider.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy_slider-box\">\n        <div class=\"wepy_slider\">\n            <div class=\"wepy_slider-inner\" @click=\"click($event)\"  v-bind:style.once=\"{backgroundColor: backgroundColor || color}\">\n                <div class=\"wepy_slider-track\" v-bind:style.once=\"{width: percent + '%', backgroundColor: activeColor || selectedColor}\"></div>\n                <div class=\"wepy_slider-handler\" v-bind:style.once=\"{left: percent + '%'}\" @touchstart=\"touchstart($event)\" @touchmove=\"touchmove($event)\"></div>\n            </div>\n        </div>\n        <div class=\"wepy_slider-value\" v-show=\"showValue\">{{percent}}</div>\n    </div>\n"},/***** module 21 end *****/


/***** module 22 start *****/
/***** node_modules\wepy-web\lib\components\radio.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy_radio\">\n        <input type=\"radio\"  v-bind:name.once=\"radioName\" v-bind:checked.once=\"checked\" v-bind:disabled.once=\"disabled\" v-bind:value.once=\"value\" @change=\"change($event)\"/>\n        <i class=\"wepy_icon\"  v-bind:style.once=\"{color: color}\"></i>\n    </div>\n"},/***** module 22 end *****/


/***** module 23 start *****/
/***** node_modules\wepy-web\lib\components\radio-group.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy_radio-group\"  v-bind:id.once=\"id\">\n        <slot></slot>\n    </div>\n"},/***** module 23 end *****/


/***** module 24 start *****/
/***** node_modules\wepy-web\lib\components\checkbox.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy_checkbox\">\n        <input type=\"checkbox\"  v-bind:name.once=\"checkboxName\" v-bind:checked.once=\"checked\" v-bind:disabled.once=\"disabled\" v-bind:value.once=\"value\" @change=\"change($event)\"/>\n        <i class=\"wepy_icon\"  v-bind:style.once=\"{color: color}\"></i>\n    </div>\n"},/***** module 24 end *****/


/***** module 25 start *****/
/***** node_modules\wepy-web\lib\components\checkbox-group.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy_checkbox-group\"  v-bind:id.once=\"id\">\n        <slot></slot>\n    </div>\n"},/***** module 25 end *****/


/***** module 26 start *****/
/***** node_modules\wepy-web\lib\components\switch.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <input class=\"wepy_switch\" type=\"checkbox\"  v-bind:style.once=\"{backgroundColor: color}\" @click=\"click($event,$event)\"/>\n"},/***** module 26 end *****/


/***** module 27 start *****/
/***** node_modules\wepy-web\lib\apis\showToast.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy-api-toast\" v-show=\"show\">\n        <div class=\"wepy-api-toast__mask\" v-show=\"mask\"></div>\n        <div class=\"wepy-api-toast__bd\">\n            <div v-show=\"icon\">\n                <div class=\"wepy-api-toast__bd__img\"  v-bind:class.once=\"icon === 'loading' ? 'wepy-api-toast__bd__img__loading' : 'wepy-api-toast__bd__img__success'\"></div>\n            </div>\n            <div class=\"wepy-api-toast__bd__title\">{{title}}</div>\n        </div>\n    </div>\n"},/***** module 27 end *****/


/***** module 28 start *****/
/***** node_modules\wepy-web\lib\apis\showActionSheet.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy-api-actionsheet\" v-show=\"show\">\n        <div class=\"wepy-api-actionsheet__mask\" @click=\"cancel($event)\"></div>\n        <div class=\"wepy-api-actionsheet__main wepy-api-actionsheet__toggle\" id=\"iosActionsheet\">\n            <div class=\"wepy-api-actionsheet__menu\">\n                <div class=\"wepy-api-actionsheet__cell\" v-for=\"(index, item) in itemList\" @click=\"select(index,$event)\">{{item}}</div>\n            </div>\n            <div class=\"wepy-api-actionsheet__action\">\n                <div class=\"wepy-api-actionsheet__cell\" @click=\"cancel($event)\">取消</div>\n            </div>\n        </div>\n    </div>\n"},/***** module 28 end *****/


/***** module 29 start *****/
/***** node_modules\wepy-web\lib\apis\showModal.vue *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"wepy-api-dialog\" v-show=\"show\">\n        <div class=\"wepy-api-dialog__mask\"></div>\n        <div class=\"wepy-api-dialog__main\">\n            <div class=\"wepy-api-dialog__hd\" v-show=\"title.length\"><strong class=\"wepy-api-dialog__title\">{{title}}</strong></div>\n            <div class=\"wepy-api-dialog__bd\" v-show=\"content.length\">{{content}}</div>\n            <div class=\"wepy-api-dialog__ft\">\n                <a href=\"javascript:;\" class=\"wepy-api-dialog__btn wepy-api-dialog__btn_default\" @click=\"cancel($event)\" v-show=\"showCancel\"  v-bind:style.once=\"{color: cancelColor}\">{{cancelText}}</a>\n                <a href=\"javascript:;\" class=\"wepy-api-dialog__btn wepy-api-dialog__btn_primary\" @click=\"confirm($event)\"  v-bind:style.once=\"{color: confirmColor}\">{{confirmText}}</a>\n            </div>\n        </div>\n    </div>\n"},/***** module 29 end *****/
...
__wepy_require(31).default.$createApp(_class, {"routes":{"pages/list":33,"pages/index":36,"pages/search":39},"style":[17,35,38,40,43,44,46,47,48,49,60,68,69,70,71,72],"components":{"navigator":0,"button":1,"icon":2,"progress":3,"slider":4,"radio":5,"radio-group":6,"checkbox":7,"checkbox-group":8,"switch":9},"apis":{"showToast":10,"showActionSheet":11,"showModal":12}}, {});
...
var _app = __wepy_require(51);

var _app2 = _interopRequireDefault(_app);

var _page = __wepy_require(52);

var _page2 = _interopRequireDefault(_page);

var _component = __wepy_require(53);
...
var Index = function (_wepy$page) {
    ...
    function Index() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$repeat = {}, _this.$props = { "my-swiper": { "indicator-dots": "true", "autoplay": "true", "interval": "3000", "duration": "500", "style": "height:{{imageHeight}}px;" } }, _this.$events = {}, _this.components = {
            'my-swiper': _swiper2.default
        }, _this.data = {
            imgUrls: [],
...
/***** module 38 start *****/
/***** src\pages\index.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = ".index .z-search {\n  padding: 10px;\n  font-size: 14px;\n  background-color: #f96153;\n  color: #fff;\n}\n.index .z-search .input {\n  background-color: #f04e43;\n  padding: 6px 10px;\n  border-radius: 8px;\n}\n.index .z-tabs {\n  display: inline-block;\n  height: 34px;\n  white-space: nowrap;\n  font-size: 14px;\n  width: 100%;\n}\n.index .z-tabs view {\n  display: inline-block;\n  padding: 6px 6px 4px 6px;\n  border-bottom: 2px solid #fff;\n}\n.index .z-tabs view.selected {\n  color: #ff6140;\n  border-color: #ff6140;\n}\n.index .special .thtj .weui-flex__item {\n  border-right: 1px solid #e2e2e9;\n  border-bottom: 1px solid #e2e2e9;\n}\n.index .special .iconfont:before {\n  margin-left: 4px;\n  margin-right: 4px;\n}\n.index .special .iconfont {\n  font-size: 16px;\n  margin-bottom: 4px;\n}\n.index .special {\n  margin-top: 10px;\n}\n.index .special .thtj {\n  border-top: 2px solid #f28430;\n}\n.index .special .hyjx1 {\n  border-top: 2px solid #a44bd0;\n}\n.index .special .hyhh {\n  border-top: 2px solid #ec495e;\n}\n\n"},/***** module 38 end *****/
...
/***** module 40 start *****/
/***** src\pages\search.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = ".page.search {\n  background: #fff;\n  padding: 10px;\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n}\n.page.search .search input {\n  display: inline-block;\n  background-color: #faf5f5;\n  width: calc(100% - 80px);\n  height: 40px;\n  border-radius: 8px;\n  padding-left: 10px;\n}\n.page.search .search button {\n  display: inline-block;\n  width: 60px;\n  margin-left: 10px;\n  background-color: #f96150;\n  border-radius: 8px;\n  font-size: 16px;\n  color: #fff;\n  height: 40px;\n}\n.page.search .hot .title {\n  color: #f8503d;\n}\n.page.search .hot .tag {\n  overflow: hidden;\n}\n.page.search .hot .tag .tag-item {\n  display: inline;\n  background-color: #f4f4f4;\n  border: 1px solid #f4f4f4;\n  padding: 2px 8px;\n  font-size: 14px;\n  border-radius: 8px;\n  color: #998c8c;\n  margin-right: 20px;\n  margin-top: 10px;\n  float: left;\n}\n.page.search .history {\n  margin-top: 10px;\n}\n.page.search .title .iconfont {\n  float: right;\n  color: #333;\n}\n\n"},/***** module 40 end *****/
...
var _component2 = __wepy_require(53);
...
var _vue = __wepy_require(62);

var _vue2 = _interopRequireDefault(_vue);

var _vueRouter = __wepy_require(63);
...
var _axios = __wepy_require(65);

var _axios2 = _interopRequireDefault(_axios);

var _query = __wepy_require(66);

var _device = __wepy_require(67);
...
/***** module 60 start *****/
/***** src\components\swiper.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = ".scroll-view {\n  height: 100%;\n  overflow: auto;\n}\n\n"},/***** module 60 end *****/
